...
public enum VideoStreamInfo {
    ...
    internal static func createFromRPC(_ rpcVideoStreamInfo: Dronecore_Rpc_Camera_VideoStreamInfo) -> VideoStreamInfo {
...
public struct VideoStreamSettings: Equatable {
    ...
    internal static func createFromRPC(_ rpcVideoStreamSettings: Dronecore_Rpc_Camera_VideoStreamSettings) -> VideoStreamSettings {
...
public struct Quaternion: Equatable {
    ...
    internal static func createFromRPC(_ rpcQuaternion: Dronecore_Rpc_Camera_Quaternion) -> Quaternion {
...
public struct CaptureInfo: Equatable {
    ...
    internal static func createFromRPC(_ rpcCaptureInfo: Dronecore_Rpc_Camera_CaptureInfo) -> CaptureInfo {
        return CaptureInfo(position: Position.createCameraFromRPC(rpcCaptureInfo.position), quaternion: Quaternion.createFromRPC(rpcCaptureInfo.quaternion), timeUTC: rpcCaptureInfo.timeUtcUs, isSuccess: rpcCaptureInfo.isSuccess, index: rpcCaptureInfo.index, fileURL: rpcCaptureInfo.fileURL)
    }
...
public struct Setting {
    ...
    internal static func createFromRPC(_ rpcSetting: Dronecore_Rpc_Camera_Setting) -> Setting {
        return Setting(id: rpcSetting.id, description: rpcSetting.description_p, option: Option.createFromRPC(rpcSetting.option))
    }
}
...
public struct Option {
    ...
    internal static func createFromRPC(_ rpcOption: [Dronecore_Rpc_Camera_Option]) -> [Option] {
        var options = [Option]()
    ...
    private func createVideoStreamInfoObservable() -> Observable<VideoStreamInfo> {
        return Observable.create { observer in
            ...
            do {
                ...
                while let response = try? call.receive() {
                    let videoStreamInfo = VideoStreamInfo.createFromRPC(response.videoStreamInfo)
    ...
    public func createCaptureInfoObservable() -> Observable<CaptureInfo> {
        return Observable.create { observer in
            ...
            do {
                ...
                while let response = try? call.receive() {
                    let captureInfo = CaptureInfo.createFromRPC(response.captureInfo)
        ...
        return Single<[Setting]>.create { single in
            ...
            do {
                ...
                getPossibleSettingsResponse.setting.forEach { setting in
                    settings.append(Setting.createFromRPC(setting))
                }
